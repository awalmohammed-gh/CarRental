      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
            <span className="text-[#2563EB]">Recommended</span>
            <span className="text-[#1E293B]"> Vehicles</span>
          </h2>
          <p className="text-[#0F172A]/70 text-lg max-w-2xl mx-auto">
            Discover a selection of cars tailored to your preferences, available for both rent and purchase at great prices.
          </p>
        </motion.div>
